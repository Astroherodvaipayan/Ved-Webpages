        ...
        >
            ...
            <div className={styles.shareBox}>
                ...
                <p className={styles.shareSub}>
                    Share your unique link. For every friend who joins, you move up <strong>5 spots</strong>.
                </p>
                ...
                <p className={styles.shareFooter}>
                    Powered by <strong>Ved AI</strong>
                </p>
            </div>
        </motion.div>
    );
