...
export default function Mission() {
    ...
    return (
        <section id="mission" className="relative w-full py-40 overflow-hidden text-center">
            {/* Background Glow */}
            ...
            >
                ...
                <div className="my-10 flex flex-col items-center">
                    <motion.h3
                        className="text-2xl md:text-4xl font-bold tracking-tight text-white/90 w-full leading-snug"
                        initial={{ opacity: 0 }}
                        animate={isInView ? { opacity: 1 } : { opacity: 0 }}
                        transition={{ delay: 0.3, duration: 0.5 }}
                    >
                        <motion.div className="block mb-3 text-center">
                            <SlicedReveal text="WE ARE BUILDING" delay={0.4} trigger={isInView} />
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="flex flex-wrap items-baseline justify-center gap-x-2 gap-y-0"
                        >
                            <motion.span layout className="text-white/90">
                                THE
                            </motion.span>
                            <SlotMachineText
                                ...
                                interval={2500}
                                trigger={isInView}
                                className="text-transparent bg-clip-text bg-gradient-to-r from-accent-primary to-accent-secondary"
                            />
                        </motion.div>

                        <motion.div className="block mt-3 text-center">
                            <SlicedReveal text="AGENT." delay={0.7} trigger={isInView} />
                        </motion.div>
                    </motion.h3>
                </div>
            ...
            <div className="relative h-56 w-screen left-1/2 -translate-x-1/2">
                ...
                >
                    ...
                    {/* Left side - CHAOTIC SCRIBBLE LINES (confused student's mind) */}
                    <motion.path
                    ...
                    />
                    <motion.path
                        d="M 0 70 C 60 150, 130 30, 220 130 C 330 200, 310 40, 430 110 C 530 170, 510 60, 630 100 C 730 130, 710 100, 750 112"
                        fill="none"
                        stroke="#666666"
                        strokeWidth="1.8"
                        strokeLinecap="round"
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 2.3, delay: 0.25, ease: "linear" }}
                    />
